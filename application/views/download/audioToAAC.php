            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="active treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="active"><a href="<?php echo site_url('/audioconverter/upload_audio_to_aac');?>"><i class="fa fa-circle-o"></i> Convert to FLAC</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
        ...
        <section class="content">
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">Download "trackwav.flac"</h3>
                </div>

                <div class="box-body">
                    <div class="row">
                        <div class="col-md-12">
                            <a href="<?php echo site_url('/audioconverter/download_aac');?>" class="btn btn-sm btn-github">Download FLAC</a>
                        </div>
                    </div>
                </div>
