            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="active treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="active"><a href="<?php echo site_url('/imageconverter/upload_image_to_jpg');?>"><i class="fa fa-circle-o"></i> Convert to JPG</a></li>
                ...
                <script type="text/javascript">
                    ...
                    function onSrcChange() {
                        ...
                        if (divimg.src!="<?php echo base_url('/assets/img/placeholder.png');?>") {
                            ...
                            $.ajax({
                                type : "POST",
                                url  : "<?php echo site_url('/imageconverter/save_temp_file_jpg'); ?>",
                                data : ({url : url}),
                                success : function(data) {
                                    var element = document.createElement("a");
                                    element.href = "<?php echo site_url('/imageconverter/download_jpg'); ?>";
